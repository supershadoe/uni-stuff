...
<body>
    ...
    <main>
        ...
        <form action="transact.php" method="post">
            <label for="amt">Enter amount to deposit</label>
            <input id="amt" name="amt" type="number" required />
            <input name="t_type" type="hidden" value="CR" />
            <input type="submit" class="btn bg-blue text-white" value="Deposit" />
        </form>
</body>
</html>
